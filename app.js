const languages = ["Nodejs", "Reactjs", "Vuejs", "Larlavel"];
...
// console.log(languages[0]);//giv index take value
...
// console.log(languages.indexOf("Larlavel"));
...
// console.log(languages[testnumber.next().value]);//Larlavel
